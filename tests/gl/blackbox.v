...
module tdc_inline_2(clk_i, rst_n_i, bus_in, inp_i, bus_out, VGND, VPWR);
  ...
  input inp_i;
  input rst_n_i;
endmodule // tdc_inline_2
`endif

`ifdef TDC_INLINE_3_BB
module tdc_inline_3(clk_i, rst_n_i, bus_in, inp_i, bus_out, VGND, VPWR);
  ...
  input inp_i;
  input rst_n_i;
endmodule // tdc_inline_3
`endif

`ifdef TDC_HD_CBUF2_X4_BB
