...
# For opentdc
yosys -m $GHDL_PLUGIN -p "ghdl rtl/opentdc_delay.vhdl rtl/opentdc_delay-sky130.vhdl rtl/opentdc_sync.vhdl rtl/opentdc_tapline.vhdl rtl/opentdc_pkg.vhdl rtl/opentdc_time.vhdl rtl/opentdc_core2.vhdl rtl/openfd_core.vhdl rtl/opentdc_wb.vhdl -e; chtype -map sky130_delay sky130_fd_sc_hd__clkdlybuf4s15_1; write_verilog src/opentdc.v; rename sky130_delay sky130_fd_sc_hd__clkdlybuf4s15_1; write_verilog -blackboxes src/bb.v"
